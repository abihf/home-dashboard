...
<div class="grid grid-cols-2 gap-2">
	...
	<Progress percent={status.cpuTemp ?? 0} icon={tempIcon}>
	...
	<Progress percent={status.memUsage.percent} className="col-span-2" icon={memIcon}>
		{normalizeSize(status.memUsage.usage)}B
	</Progress>

	{#snippet diskIcon()}<svg
		xmlns="http://www.w3.org/2000/svg"
		fill="none"
		viewBox="0 0 24 24"
		stroke-width="1.5"
	...
	<Progress percent={status.diskMedia.percent} icon={mediaIcon}>
	...
	<Progress percent={status.download.percent} icon={downloadIcon}>
		{normalizeSize(status.download.usage, 0)}B/s
	</Progress>

	{#snippet uploadIcon()}<svg
		xmlns="http://www.w3.org/2000/svg"
		fill="none"
		viewBox="0 0 24 24"
		stroke-width="1.5"
	...
	<Progress percent={status.upload.percent} icon={uploadIcon}>
